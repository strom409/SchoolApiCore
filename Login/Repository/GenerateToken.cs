    ...
    public class GenerateToken
    {
        ...
        public static async Task<string> CreateToken(string connectionString, string userId, string clientId, IConfiguration configuration)
        {
            try
            {
                ...
                // var expirySeconds =DateTime.Now.AddMinutes(Convert.ToDouble(configuration["AuthTokenExpiry"]));
                var expiryMinutes = Convert.ToDouble(configuration["TokenSettings:AuthTokenExpiry"]);
